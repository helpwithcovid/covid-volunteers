...
# PROJECTS
project1 = Project.create(user: user, name: 'Act Now Foundation - Import & distribution of 10-minute at home COVID-19 test kits', location: 'USA', description: 'A cool description', highlight: true)
...
project3 = Project.create(user: user, name: 'Virtual homework supervision to help overwhelmed parents while school is closed project', location: 'Brooklyn', description: 'With elementary schools suddenly closed for the rest of the year, parents are struggling to balance work, caring for others and the sudden responsibility for keeping their children educated and on track for school.', highlight: true)
...
project5 = Project.create(user: user, name: 'Selfie lenses to spread public health into in a fun way project ', description: %{We are a group called Lefty Lenses who have been applying selfie lenses (like the Snapchat puppy filter) to politics for the 2020 election. Our lenses have reached 125M people in 10 weeks, and we've spent $0.}, highlight: true)
