class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.fetch(:project, {}).permit(:name, :description, :participants, :looking_for, :contact, :location, :progress, :docs_and_demo, :number_of_volunteers, :slack_url, :discord_url, :github_url, :social_media_links, :skill_list => [], :project_type_list => [])
    end
