class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.fetch(:project, {}).permit(:name, :description, :participants, :looking_for, :contact, :location, :progress, :number_of_volunteers_needed, :skill_list => [], :project_type_list => [])
    end
