class ProjectsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html do
        @projects_header = 'New Haven Residents vs. COVID-19'
  ...
  private
    ...
    def project_params
      params.fetch(:project, {}).permit(:name, :organization, :level_of_urgency, :description, :participants, :looking_for, :contact, :location, :start_date, :end_date, :compensation, :background_screening_required, :progress, :docs_and_demo, :number_of_volunteers, :skill_list => [], :project_type_list => [])
    end
