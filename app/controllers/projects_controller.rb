class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.fetch(:project, {}).permit(:name, :description, :participants, :looking_for, :contact, :volunteer_location, :target_country, :target_location, :progress, :docs_and_demo, :accepting_volunteers, :number_of_volunteers, :links, :status, :skill_list => [], :project_type_list => [])
    end
