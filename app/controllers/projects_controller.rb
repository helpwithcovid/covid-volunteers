class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.fetch(:project, {}).permit(:name, :organization, :level_of_urgency, :description, :participants, :looking_for, :contact, :location, :start_date, :end_date, :compensation, :progress, :docs_and_demo, :number_of_volunteers, :skill_list => [], :project_type_list => [])
    end
