...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_account_update_params
    devise_parameter_sanitizer.permit(:account_update, keys: [ :name, :about, :profile_links, :location, :remote_location, :visibility, :pair_with_projects,  :level_of_availability, :phone, :affiliation, :resume, :skill_list => []])
  end
