module ApplicationHelper
  ...
  def filter_badge(label: nil, model: nil, is_link: true, filter_by: nil, color: nil)
    ...
    render partial: 'partials/filter-badge', locals: {label: label, url: url, classes: classes, is_link: is_link}
  end
end
